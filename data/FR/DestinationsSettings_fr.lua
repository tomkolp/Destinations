...
do
  ...
  Add("DEST_SETTINGS_POI_ENGLISH_KEEPS_NL_TT",
    "Ajouter une nouvelle ligne sur les tooltips de fort pour le nom anglais")
  Add("DEST_SETTINGS_POI_IMPROVE_MUNDUS", "Améliorer les PI des Pierres de Mundus")
  Add("DEST_SETTINGS_POI_IMPROVE_MUNDUS_TT",
    "Améliorer les points d'intérêt des Pierres de Mundus en ajoutant la description de l'effet sur le tooltip")
  ...
  Add("DEST_SETTINGS_POI_IMPROVE_CRAFTING_TT",
    "Améliorer les points d'intérêt des Stations d'artisanat en ajoutant la description du set sur le tooltip")
  ...
  Add("DEST_SETTINGS_UNKNOWN_COLOR_EN_TT",
    "Défini la couleur des textes en anglais pour tous les Points d'Intérêt inconnus, si activé.")
  ...
  Add("DEST_SETTINGS_KNOWN_COLOR_EN_TT",
    "Défini la couleur des textes textes en anglais pour tous les Points d'Interêt connus, si activé")
  ...
  Add("DEST_SETTINGS_ALL_SHOW_ENGLISH",
    "Afficher également les noms des PI en Anglais") -- Should read "Show english POI names" on all non-english clients.
  ...
  Add("DEST_SETTINGS_ACH_CHAMPION_ZONE_PIN_TOGGLE_TT",
    "Cette options est pour afficher les Champions (de donjon solo) sur la CARTE DE ZONE")
  ...
  Add("DEST_SETTINGS_ACH_CHAMPION_FRONT_PIN_TOGGLE_TT",
    "Activer pour que  les icônes de soient zône au dessus (si actives) des icônes des donjons ou non.")
  ...
  Add("DEST_SETTINGS_MISC_HEADER_TT",
    "Ce sous-menu couvre les Puits Ayléides, les ruines Dwemer et la Frontière de Raidelorn.")
  ...
  Add("DEST_SETTINGS_VWW_HEADER_TT",
    "Ce sous-menu couvrel les Vampires et les Loups-Garous, incluant les lieux d'apparition, les autels et les sanctuaires.")
  ...
  Add("DEST_SETTINGS_VWW_PIN_WWVAMP_TOGGLE_TT",
    "Activer pour afficher les lieux d'apparition des Vampires & Loups-Garous sur la carte")
  ...
  Add("DEST_SETTINGS_VWW_PIN_COLOR_TT",
    "Défini la couleur des icônes des Loups-Garous, Vampires, Sanctuaires Loup-Garou et Autels Vampire")
  Add("DEST_SETTINGS_VWW_PINTEXT_COLOR", "Couleur du texte pour les LG/Vampires")
  Add("DEST_SETTINGS_VWW_PINTEXT_COLOR_TT",
    "Défini la couleur du texte des Loups-Garous, Vampires, Sanctuaires Loup-Garou et Autels Vampire")
  ...
  Add("DEST_SETTINGS_QUEST_UNDONE_MAIN_PIN_COLOR_TT",
    "Défini la couleur de l'icône des quêtes de l'HISTOIRE PRINCIPALE non débutées")
  Add("DEST_SETTINGS_QUEST_UNDONE_DAY_PIN_COLOR", "Couleur de l'icône des quêtes journalières")
  Add("DEST_SETTINGS_QUEST_UNDONE_DAY_PIN_COLOR_TT",
    "Défini la couleur de l'icône des QUÊTES JOURNALIÈRES non débutées")
  ...
  Add("DEST_SETTINGS_QUEST_INPROGRESS_PIN_COLOR_TT",
    "Défini la couleur des icônes des quêtes actuellement dans le journal")
  Add("DEST_SETTINGS_QUEST_INPROGRESS_PINTEXT_COLOR", "Couleur du texte des quêtes en cours")
  Add("DEST_SETTINGS_QUEST_INPROGRESS_PINTEXT_COLOR_TT",
    "Défini la couleur du texte des quêtes actuellement dans le journal")
  ...
  Add("DEST_SETTINGS_QUEST_CADWELLS_PIN_TOGGLE_TT",
    "Active les indicateurs des quêtes de l'Amanach de Cadwell sur la carte")
  ...
  Add("DEST_SETTINGS_QUEST_CADWELLS_ONLY_PIN_TOGGLE_TT",
    "Cache toutes les quêtes ordinaires qui ne font pas partie de l'Almanach de Cadwell")
  ...
  Add("DEST_SETTINGS_REGISTER_QUESTS_TOGGLE_TT",
    "Enregistre les informations des quêtes pour rapport. Veuillez vous rendre sur la page EOSUI.com de l'add-on Destination pour plus d'information")
  Add("DEST_SETTINGS_QUEST_RESET_HIDDEN", "RAZ des quêtes cachées")
  Add("DEST_SETTINGS_QUEST_RESET_HIDDEN_TT",
    "Remet à zéro toutes les quêtes cachées, et les réaffiche sur la carte et le compas.")
  ...
  Add("DEST_SETTINGS_COLLECTIBLES_TOGGLE_TT",
    "Active l'affichage des zones où les monstres peuvent être tués afin de collecter les trophées pour compléter les succès")
  Add("DEST_SETTINGS_COLLECTIBLES_DONE_TOGGLE", "Afficher les trophées collectés")
  Add("DEST_SETTINGS_COLLECTIBLES_DONE_TOGGLE_TT",
    "Active l'affichage des zones où les trophées ont déjà été collectés")
  ...
  Add("DEST_SETTINGS_COLLECTIBLES_SHOW_MOBNAME_TT",
    "Active l'affichage du nom des monstres (en anglais uniquement) qui donnent l'objet nécessaire pour compléter les succès")
  Add("DEST_SETTINGS_COLLECTIBLES_SHOW_ITEM", "Afficher le nom de l'objet")
  Add("DEST_SETTINGS_COLLECTIBLES_SHOW_ITEM_TT",
    "Active l'affichage du nom des objets nécessaire pour compléter les succès")
  ...
  Add("DEST_SETTINGS_COLLECTIBLES_COMPASS_DIST_TT",
    "Défini la distance d'affichage des icônes des Trophées sur le compas")
  Add("DEST_SETTINGS_COLLECTIBLES_COLOR_TITLE", "Couleur des Titres")
  Add("DEST_SETTINGS_COLLECTIBLES_COLOR_TITLE_TT",
    "Défini la couleur des titre reflètant les nom des Succès des Trophées")
  ...
  Add("DEST_SETTINGS_FISHING_TOGGLE_TT",
    "Active l'affichage des trous de Pêche où il y a une chance de capturer un poisson pour les succès")
  ...
  Add("DEST_SETTINGS_FISHING_SHOW_BAIT_LEFT_TT",
    "Active l'affichage du nombre d'appat du type optimal qu'il vous reste dans votre sac. SI il y a un troisième chiffre, il correspond à l'appat simple.")
  ...
  Add("DEST_SETTINGS_FISHING_COLOR_BAIT_UNDONE_TT",
    "Défini la couleur du texte des appats idéaux pour les poissons non pêchés")
  ...
  Add("DEST_SETTINGS_FISHING_COLOR_WATER_UNDONE_TT",
    "Défini la couleur du texte des type d'eaux pour les poissons non pêchés")
  ...
  Add("DEST_SETTINGS_FISHING_COLOR_BAIT_DONE_TT",
    "Défini la couleur du texte des appats idéaux pour les poissons déjà pêchés")
  ...
  Add("DEST_SETTINGS_FISHING_COLOR_WATER_DONE_TT",
    "Défini la couleur du texte des type d'eaux pour les poissons déjà pêchés")
  ...
  Add("DEST_SETTINGS_MAPFILTERS_MISS_TOGGLE_TT",
    "Shows/hides Map Filters for Miscellaneous pins (Ayleid Wells, Dwemer Ruins, Craglorn Border, as well as all Werewolf and Vampire pins).")  -->> NEW
